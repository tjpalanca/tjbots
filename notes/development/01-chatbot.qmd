...
- Shiny Server Open Source
    ...
    - I eventually gave this a try, but it was not a good experience. The reconnection behavior was not as good as I hoped, and it was a pain to set up. I had to build from source, and the fact that environment variables are not pass through along with headers, requiring source code changes, was a pain.
...
- ShinyProxy
    ...
    - The reconnection behavior was OK, there was a problem with the latest chat being resent, which I will try to remedy through application code.
